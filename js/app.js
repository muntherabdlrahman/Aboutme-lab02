...
switch(fiveAns.toLowerCase()){
    ...
    case 'y':
        ...
        document.write('I worked as a Shawerma maker and i have a 2 years experiance with that work you should try my Shawerma ! so Delecious!                                                                                                               ')

        break;
        case 'no':
        case 'n':
            console.log('Hm; so weird  ')
            document.write('You should try it from my hand!')
            break;
            default:
